...
function updateColor(colorID, textID, pColor) {
	...
	gsap.to(colorEL, {background: getHexColor(pColor), duration: fadeInTime});
...
function getHexColor(color) {
	switch (color) {
		case "Red":
			return "linear-gradient(to top, #000000, #E90004)";
		case "Blue":
			return "linear-gradient(to top, #000000, #0A69E7)";
		case "Yellow":
			return "linear-gradient(to top, #000000, #EDAD09)";
		case "Green":
			return "linear-gradient(to top, #000000, #0DB321)";
		case "CPU":
			return "linear-gradient(to top, #000000, #808080)";
		default:
			return "linear-gradient(to top, #000000, #808080)";
	}
}
